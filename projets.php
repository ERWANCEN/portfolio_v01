...
<body class="<?php echo isset($_COOKIE['darkMode']) && $_COOKIE['darkMode'] === 'true' ? 'dark' : ''; ?>">
    <div id="container_general">
        ...
        <div id="container_projets">
            <h2 id="mes_réalisations" class="titre_principal texte_dark_mode">Mes réalisations</h2>
            <div id="projets_grid">
                <p class="texte texte_dark_mode" id="texte_projets_dev">Découvrez mes projets en développement web, où la structure, la performance et l'interactivité sont au cœur de mes réalisations.</p>

                <?php foreach ($projets as $projet): ?>
                <a href="/portfolio_v01/projet.php?id=<?php echo htmlspecialchars($projet['id_projet']); ?>" class="vignette_projet">
                    ...
                    <div class="bas_vignette">
                        <h3 class="nom_du_projet texte_dark_mode"><?php echo htmlspecialchars($projet['titre']); ?></h3>
                        <img class="fleche_droite" src="/portfolio_v01/assets/images/fleche_droite.svg" alt="">                    
                    </div>
                </a>
                <?php endforeach; ?>
                <a href="https://github.com/ERWANCEN?tab=repositories" target="_blank" rel="noopener noreferrer" class="cta texte_dark_mode">
