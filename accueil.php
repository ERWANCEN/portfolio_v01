        ...
        <header>
            <div id="container_header_tablette_desktop">
                ...
                <div id="container_header">
                    ...
                    <div id="mode_jour_nuit_container">
                        <img id="mode_jour_nuit" src="assets/images/soleil_blanc.svg" alt="soleil indiquant le mode jour">
                    </div>
                </div>
            </div>
            ...
            <div id="container_header_mobile">
                ...
                <img src="assets/images/france.webp" alt="" class="mode_langue" loading="lazy">
                <img id="mode_jour_nuit" src="assets/images/soleil.svg" alt="soleil indiquant le mode jour">
